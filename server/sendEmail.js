...
//   	// 'sendEmail2'(to, from, subject, text) {
//   	// 	process.env.MAIL_URL = "smtp://postmaster%40finchatbot.mailgun.org:5e66679eec3180b029b627343e020848@smtp.mailgun.org:587";
...
//   	// 'sendEmail3'(to, from, subject, text) {
//   	// 	process.env.MAIL_URL = "smtp://postmaster%40martin@finchatbot.com.mailgun.org:5e66679eec3180b029b627343e020848@smtp.mailgun.org:587";
// 	  //   // check([to, from, subject, text], [String]);
// 	  //   // Let other method calls from the same client start running,
// 	  //   // without waiting for the email sending to complete.
// 	  //   this.unblock();
...
//   	// 'sendEmail4'(to, from, subject, text) {
//   	// 	process.env.MAIL_URL = "smtp://postmaster%40finchatbot:5e66679eec3180b029b627343e020848@smtp.mailgun.org:587";
// 	  //   // check([to, from, subject, text], [String]);
// 	  //   // Let other method calls from the same client start running,
// 	  //   // without waiting for the email sending to complete.
// 	  //   this.unblock();
...
//   		process.env.MAIL_URL = "smtp://martin%40finchatbot.com:5e66679eec3180b029b627343e020848@smtp.mailgun.org:587";
// 	    // check([to, from, subject, text], [String]);
// 	    // Let other method calls from the same client start running,
// 	    // without waiting for the email sending to complete.
// 	    this.unblock();
...
// // +'            <tr>'
// // +'              '
// // +'              <td width="94%" style="font-family:Gotham, &#39;Helvetica Neue&#39;, Helvetica, Arial, sans-serif; font-size:12px; line-height:19px; color:#ffffff">Dear "Customer",</td>'
// // +'            </tr>'
// // +'            <tr>'
// // +'              '
// // +'              <td style="font-family:Gotham, &#39;Helvetica Neue&#39;, Helvetica, Arial, sans-serif; font-size:12px; line-height:19px; color:#ffffff">Following your enquiry on "time/date" I am pleased to confirm your quotation for "funeral" cover.'
// // +'				You have supplied the following details:'
// // +'				</td>'
// // +'            </tr>'
// // +'            <tr>'
// // +''
// // +'              <td style="font-family:Gotham, &#39;Helvetica Neue&#39;, Helvetica, Arial, sans-serif; font-size:12px; line-height:19px; color:#ffffff">Main member: "customer name and details"'
// // +'				Cover level: "Rxxxx"'
// // +'				</td>'
// // +'            </tr>'
// // +'            <tr>'
// // +'             '
// // +'              <td style="font-family:Gotham, &#39;Helvetica Neue&#39;, Helvetica, Arial, sans-serif; font-size:12px; line-height:19px; color:#ffffff">Spouse: "spouse details"'
// // +'				Cover level: "Rxxx"'
// // +''
// // +'            </tr>'
// // +'            <tr>'
// // +''
// // +'              <td style="font-family:Gotham, &#39;Helvetica Neue&#39;, Helvetica, Arial, sans-serif; font-size:12px; line-height:19px; color:#ffffff">Children: "" Child details"'
// // +'				Cover level: "Rxxx"'
// // +'				</td>'
// // +'          </tr>'
// // +'            <tr>'
// // +''
// // +'              <td style="font-family:Gotham, &#39;Helvetica Neue&#39;, Helvetica, Arial, sans-serif; font-size:12px; line-height:19px; color:#ffffff">Please review these details to ensure that they are correct.</td>'
// // +'            </tr>'
// // +'            <tr>'
// // +'              <td style="font-family:Gotham, &#39;Helvetica Neue&#39;, Helvetica, Arial, sans-serif; font-size:12px; line-height:19px; color:#ffffff">Based upon the information you supplied your monthly premium will be "Rxxx"</td>'
// // +'            </tr>'
// // +''
// // +'            <tr>'
// // +'              	<td style="font-family:Gotham, &#39;Helvetica Neue&#39;, Helvetica, Arial, sans-serif; font-size:12px; line-height:19px; color:#ffffff">Should you wish to take advantage of this quotation simply contact us by:'
...
// // +''
// // +'            <tr>'
// // +'              <td style="font-family:Gotham, &#39;Helvetica Neue&#39;, Helvetica, Arial, sans-serif; font-size:12px; line-height:19px; color:#ffffff">Please supply the following reference number "Quote Ref number" when you contact us.</td>'
// // +'            </tr>'
// // +''
// // +'            <tr>'
// // +'              <td style="font-family:Gotham, &#39;Helvetica Neue&#39;, Helvetica, Arial, sans-serif; font-size:12px; line-height:19px; color:#ffffff">Many thanks</td>'
// // +'            </tr>'
// // +''
// // +''
// // +'          </tbody>'
