...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if (blocName === 'How can I help you') {
		...
		var skip = false;
		var input = {'type':'buttons',
					'buttons': [{'title':'Hot deals', 'response':'Let me see the Hot deals!'},/*{'title':'Locate a store', 'response':'Please help me finding the closest Vodacom store Holly'},*/{'title':'Upgrade', 'response':'I would like to upgrade my contract'},{'title':'Recharge', 'response':'I would like to recharge my phone services please Holly'},{'title':'Vodacom insurance', 'response': 'Hey Holly, I would like to get my new phone insured'}]
					};
		var dataWrapper = 'DATA';
		var createData = false;
	...
	if (blocName === 'How can I help you 2') {
		...
		if (text.match(matchWord1)) {
			...
			var dataWrapper = "I would like to buy Vodacom DATA please Holly";
			var createData = false;

		} else if (text.match(matchWord4)) {

			var botResponse = 'Sure no problem '+data['name']+'. In case you don’t know it yet, to be able to do so you must be in your last month contract. Enter your Vodacom number below and I will check if that’s your case:';
			var image = false;
			var inReplyto;
			...
			var botResponse = 'Yes no problem '+data['name']+'! Let’s process the Vodacom insurance quotation, and then you will be able to get crazy! :SMILE:';
			var image = false;
			var inReplyto;
			var nextBlocID = 'Vodacom insurance';
			var skip = true;
			var input = {"type":'none'};
			var dataWrapper = "DATA";
			var createData = false;
	...
	if (blocName === 'Find store 3') {
		...
		var botResponse = 'The closest Vodacom branch is only at 10 km from your place, located on 28 Melle St Shop 4, North City House , Braamfontein, Johannesburg 2001';
		var image = false;
		var inReplyto;
	...
	if (blocName === 'Recharge 3') {
		...
		var botResponse = 'Can you please now enter the Vodacom number you wish to recharge?';
		var image = false;
		var inReplyto;
		var nextBlocID = 'Recharge 4';
		var skip = false;
		var input = {'type':'text'}
		var dataWrapper = "The Vodacom number I want to recharge is DATA";
		var createData = false;
	...
	if (blocName === 'Default text email 2') {
		...
		var botResponse = 'By now, give me your e-mail address and I will send you a summary of the offer and you will be able to buy it through Vodacom website! Sounds good?';
		var image = false;
		var inReplyto;
	...
	if (blocName === 'Default samsung email') {
		...
		var botResponse = 'Apologize '+data['name']+', I am only the beta version of the demo version of the pilot of myself... But soon you will be able to buy Vodacom services directly by me, I promise you';
		var image = false;
		var inReplyto;
	...
	if (blocName === 'Upgrade contract 2') {
		...
		var botResponse = 'This includes itemised Billing, receiving your cellular bill statements via e-mail, data bundles, Vodacom insurance or SMS bundles etc.. Interested?';
		var image = false;
		var inReplyto;
		var nextBlocID = 'Upgrade contract 3';
		var skip = false;
		var input = {"type":'buttons',
					'buttons': [{'title': 'Yes', 'response': 'Sounds like super cool!'},{'title': 'No', 'response': 'No thanks Holly'},{'title': 'Vodacom insurance? What is that?', 'response': 'Vodacom insurance?'}]};
		var dataWrapper = "DATA";
		var createData = false;
	...
	if (blocName === 'Upgrade contract 3') {
		...
		if (text.match(matchWord1)) {
			...
			var input = {"type":"checkbox",
						"checks":[{"value": "Bill statements via e-mail"},{"value":"Itemised billing"},{"value":"Vodacom insurance"}],
						}
			var dataWrapper = "DATA";
			var createData = false;
			...
			var botResponse = 'Vodacom insurance is Vodacom cover against theft, accidental physical loss and accidental physical damage';
			var image = false;
			var inReplyto;
			var nextBlocID = 'Upgrade Vodacom insurance';
			var skip = true;
			var input = {"type":'none'};
			var dataWrapper = "DATA";
			var createData = false;
	...
	if (blocName === 'Upgrade Vodacom insurance') {
	...
	if (blocName === 'Upgrade buy phone 2') {
		...
		var botResponse = 'Do you want me to ship it to you (4-6 days) or if you can’t wait that long you can pick it up at our closest Vodacom store!';
		var image = false;
		var inReplyto;
		var nextBlocID = 'Upgrade buy phone 3';
		var skip = false;
		var input = {"type":'buttons',
					'buttons':[{'title':'Home delivery', 'response':'Home delivery'}, {'title':'I want to pick it up, it\'s mine', 'response':'I don’t wait that long Holly, please indicate me where is the closest Vodacom store'}]};
		var dataWrapper = "DATA";
		var createData = false;
	...
	if (blocName === 'Upgrade buy phone 3') {
		...
		if (text.match(matchWord1)) {
			...
			var botResponse = 'No worries! That’s simple, enter your address below and I will let you know the closest Vodacom store where you will be able to fetch your new phone';
			var image = false;
			var inReplyto;
	...
	if (blocName === 'Vodacom insurance 2') {
		...
		if (text.match(matchWord1)) {
			...
			var image = false;
			var inReplyto;
			var nextBlocID = 'Vodacom insurance phone make';
			var skip = false;
			var input = {"type":'select',
						'text':"Select your purchase",
						"choices": [{"value": "Samsung"},{"value": "Apple"},{"value": "Huawei"},{"value": "LG"},{"value": "Cat"},{"value": "Vodacom"},{"value": "LTE"},{"value": "Other"}]
						};
			var dataWrapper = "DATA";
			var createData = false;
	...
	if (blocName === 'Vodacom insurance phone make') {
		...
		if (text.match(matchWord1)) {
			...
			var image = false;
			var inReplyto;
			var nextBlocID = 'Vodacom insurance phone value';
			var skip = false;
			var input = {"type":'text'};
			var dataWrapper = "DATA";
			var createData = false;
	...
	if (blocName === 'Vodacom insurance phone value') {
		...
		var image = false;
		var inReplyto;
		var nextBlocID = 'Vodacom insurance 3';
		var skip = false;
		var input = {"type":'select',
	...
	if (blocName === 'Vodacom insurance 4') {
		...
		var image = false;
		var inReplyto;
		var nextBlocID = 'Vodacom insurance 5';
		var skip = true;
		var input = {"type":'none'};
		var dataWrapper = "DATA";
		var createData = false;
	...
	if (blocName === 'Vodacom insurance 5') {
		...
		var image = false;
		var inReplyto;
		var nextBlocID = 'Vodacom insurance TCs';
		var skip = false;
		var input = {"type":'buttons',
	...
	if (blocName === 'Vodacom insurance TCs') {
		...
		if (text.match(matchWord1)) {
			...
			var image = false;
			var inReplyto;
			var nextBlocID = 'Vodacom insurance TCs 2';
			var skip = false;
			var input = {"type":'buttons',
	...
	if (blocName === 'Vodacom insurance TCs 2') {
		...
		if (text.match(matchWord1)) {
			...
			var image = false;
			var inReplyto;
			var nextBlocID = 'Vodacom insurance email';
			var skip = false;
			var input = {"type":'multitext'};
	...
	if (blocName === 'Vodacom insurance email 2') {
		...
		if (text.match(matchWord0)) {
			...
			var image = false;
			var inReplyto;
			var nextBlocID = 'Vodacom insurance email 3';
			var skip = false;
			var input = {'type':'buttons',
						'buttons': [{'title':'Yes', 'response':'Yes Holly, that\'s right!'},{'title':'No', 'response':'No'}]
						};
	...
	if (blocName === 'Vodacom insurance email 3') {

		matchWord1 = /(.*)yes(.*)/i;

		if (text.match(matchWord1)) {
		
			var botResponse = 'Good! Now can you please enter your Vodacom phone number?';
			var image = false;
			var inReplyto;
			var nextBlocID = 'Vodacom insurance phone number 1';
			var skip = false;
			var input = {"type":'text'};
			var dataWrapper = "DATA";
	...
	if (blocName === 'Vodacom insurance phone number 1') {

		
		var botResponse = 'Is your phone number '+data['phone number']+'? Do you confirm?';
		var image = false;
		var inReplyto;
		var nextBlocID = 'Vodacom insurance phone number 2';
		var skip = false;
		var input = {'type':'buttons',
					'buttons': [{'title':'Yes', 'response':'Yes Holly, that\'s right!'},{'title':'No', 'response':'No'}]
					};
	...
	if (blocName === 'Vodacom insurance phone number 2') {
		...
		if (text.match(matchWord1)) {
			...
			var image = false;
			var inReplyto;
			var nextBlocID = 'Vodacom insurance payment';
			var skip = true;
			var input = {"type":'none'};
			var dataWrapper = "DATA";
			var createData = false;
	...
	if (blocName === 'Vodacom insurance payment') {

		
		var botResponse = 'Do you want to process the payment now?';
		var image = false;
		var inReplyto;
		var nextBlocID = 'Vodacom insurance payment 2';
		var skip = false;
		var input = {'type':'buttons',
	...
	if (blocName === 'Vodacom insurance payment 2') {
		...
		if (text.match(/.*yes.*/i)) {
			...
			var image = false;
			var inReplyto;
			var nextBlocID = 'Vodacom insurance payment 3';
			var skip = true;
			var input = {'type':'none'};
			var dataWrapper = "DATA";
			var createData = false;
	...
	if (blocName === 'Vodacom insurance payment 4') {
		...
		var image = false;
		var inReplyto;
		var nextBlocID = 'Vodacom insurance payment 5';
		var skip = true;
		var input = {'type':'none'};
		var dataWrapper = "DATA";
		var createData = false;
	...
	if (blocName === 'Vodacom insurance payment 5') {

		
		var botResponse = 'Which option would you prefer?';
		var image = false;
		var inReplyto;
		var nextBlocID = 'Vodacom insurance payment 6';
		var skip = false;
		var input = {'type':'buttons',
	...
	if (blocName === 'Vodacom insurance payment 6') {
		...
		if (text.match(/.*card.*/i)) {
			...
			var image = false;
			var inReplyto;
			var nextBlocID = 'Vodacom insurance card payment';
			var skip = true;
			var input = {'type':'none'};
			var dataWrapper = "DATA";
			var createData = false;
			...
			var image = false;
			var inReplyto;
			var nextBlocID = 'Vodacom insurance debit order';
			var skip = true;
			var input = {'type':'none'};
			var dataWrapper = "DATA";
			var createData = false;
	...
	if (blocName === 'Vodacom insurance card payment') {

		
		var botResponse = 'First of all, what is your card type?';
		var image = false;
		var inReplyto;
		var nextBlocID = 'Vodacom insurance card payment 2';
		var skip = false;
		var input = {"type":'select',
	...
	if (blocName === 'Vodacom insurance card payment 2') {

		
		var botResponse = 'Perfect. The first step is done! Now, can you please enter you card number?';
		var image = false;
		var inReplyto;
		var nextBlocID = 'Vodacom insurance card payment 3';
		var skip = false;
		var input = {"type":'text'};
	...
	if (blocName === 'Vodacom insurance card payment 3') {
		...
		if (text.match(/([0-9]{4}\s*){4}/)) {
			...
			var image = false;
			var inReplyto;
			var nextBlocID = 'Vodacom insurance card payment 4';
			var skip = false;
			var input = {"type":'multitext'};
	...
	if (blocName === 'Vodacom insurance accept card payment') {
		...
		var image = false;
		var inReplyto;
		var nextBlocID = 'Vodacom insurance accept card payment 2';
		var skip = true;
		var input = {"type":'none'};
		var dataWrapper = "DATA";
		var createData = false;
	...
	if (blocName === 'Vodacom insurance accept card payment 2') {

		
		var botResponse = 'That is perfect '+data['name']+', let me few seconds to proceed to the payment. You might be redirected toward your bank website to confirm the payment';
		var image = false;
		var inReplyto;
		var nextBlocID = 'Vodacom insurance accept card payment 3';
		var skip = true;
		var input = {"type":'none'};
		var dataWrapper = "DATA";
		var createData = false;
	...
	if (blocName === 'Vodacom insurance accept card payment 3') {
	...
	if (blocName === 'Vodacom insurance debit order') {
