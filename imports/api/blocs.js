...
// Funeral cover
	...
	// bloc funeral info
		...
		if (blocName==='Funeral info 3') {
			...
			if (text.match(/(.*)yes(.*)/i)) {
				...
				var botResponse = 'For more inforamtion about how we can help you in getting the best funeral cover as possible, please visit this LINKhttp://www.finchatbot.comTEXTpageEND';
				var image = false;
				var inReplyto;
	...
	if (blocName==='Car comprehensive insurance 3') {
		...
		if (text.match(matchWord1)) {
			...
			var botResponse = 'You can find more informations on our LINKhttp://www.finchatbot.comTEXTwebsiteEND';
			var image = false;
			var inReplyto;
			var nextBlocID = 'Car get driver previous insurance';
			var skip = true;
