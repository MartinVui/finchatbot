  	...
  	'sendEmail'(type, data) {
		...
		// Funeral mail for Metropolitan
  		if (type === "Funeral") {
			...
			+'				<br/>Email: <a style="color:black" href="hello@finchatbot.com">hello@metropolitan.com</a>'
			+'				</td>'
			+'          </tr>'
			+''
			+'            <tr>'
