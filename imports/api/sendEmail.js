  	...
  	'sendEmail'(type, data) {
		...
		// Car mail for Miway
  		if (type === "Credit life") {
			...
			+'    <!-- Full Width, Fluid Column : BEGIN -->'
			+'    <tbody><tr>'
			+'      <td><a href="https://www.miway.co.za/car-insurance" "target="_blank"?utm_source=PI&utm_medium=BANNER&utm_term=HOLLARD&utm_campaign=HOLLARD "target="_blank"?utm_source=PI&utm_medium=BANNER&utm_term=HOLLARD&utm_campaign=HOLLARD "target="_blank"><img src="http://www.flyingcircus.tv/wp-content/uploads/2014/09/Portfolio_MiWay_06.jpg" width="100%" height="auto" alt="Get Affordable credit life insurance with Miway"></a></td>'
			+'    </tr>'
			+'      <tr>'
			+'        <td align="center" style="padding:10px; background-color:#fff"><table width="100%" border="0" cellspacing="8" cellpadding="6">'
			+'          <tbody>'
