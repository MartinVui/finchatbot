  	...
  	'sendEmail'(type, data) {
		...
		// Funeral mail for Metropolitan
  		if (type === "iphone") {
			...
			+'    <tbody><tr>'
			+'      <td><a href="https://www.mtn.co.za" "target="_blank"?utm_source=PI&utm_medium=BANNER&utm_term=HOLLARD&utm_campaign=HOLLARD "target="_blank"?utm_source=PI&utm_medium=BANNER&utm_term=HOLLARD&utm_campaign=HOLLARD "target="_blank"><img src="http://moninternet.mtn.ci/img/mtn-logo.jpg" width="100%" height="auto"></a></td>'
			+'    </tr>'
			+'      <tr>'
			...
			+'				it seems that you might be interested by the following offer:'
			+'				</td>'
			+'            </tr>'
			+'            <tr>'
			+''
			+'              <img src="https://finchatbot-mtn.herokuapp.com/images/iphone.png" style=" width:100%; height:auto";/>'
			+''
			+'            <tr>'
			+'            <tr>'
			+''
			...
			+'				<br/>Email: <a style="color:black" href="hello@mtn.com">hello@mtn.com</a>'
			+'				</td>'
			+'          </tr>'
			+''
			+'            <tr>'
			...
			+'      '
			+'      <tr>'
			+'        <td style="padding-left:20px; padding-top:15px; padding-right:5px; padding-bottom:15px; background-color:#000; font-family:&#39;Helvetica Neue&#39;, Helvetica, Arial, sans-serif; font-size:8px; line-height:19px; color:#ffffff">MTN is an authorised telecom services provider. Terms and &amp; Conditions apply.</td>'
			+'      </tr>'
			+''
			+''
			+'</tbody></table>'
		...
		// Funeral mail for Metropolitan
  		if (type === "samsung") {
			...
			+'            <tr>'
			+''
			+'              <img src="https://finchatbot-mtn.herokuapp.com/images/samsung.png" style=" width:100%; height:auto";/>'
			+''
			+'            <tr>'
			+'            <tr>'
			+''
		...
		// Funeral mail for Metropolitan
  		if (type === "airtime") {
			...
			+'    <!-- Full Width, Fluid Column : BEGIN -->'
			+'    <tbody><tr>'
			+'      <td><a href="https://www.mtn.co.za" "target="_blank"?utm_source=PI&utm_medium=BANNER&utm_term=HOLLARD&utm_campaign=HOLLARD "target="_blank"?utm_source=PI&utm_medium=BANNER&utm_term=HOLLARD&utm_campaign=HOLLARD "target="_blank"><img src="http://moninternet.mtn.ci/img/mtn-logo.jpg" width="100%" height="auto" alt="Get Affordable Funeral Cover with Hollard"></a></td>'
			+'    </tr>'
			+'      <tr>'
			+'        <td align="center" style="padding:10px; background-color:#fff"><table width="100%" border="0" cellspacing="8" cellpadding="6">'
			+'          <tbody>'
			...
			+'              '
			+'              <td style="font-family:&#39;Helvetica Neue&#39;, Helvetica, Arial, sans-serif; font-size:13px; line-height:19px; color:#000">Following your conversation with Holly,'
			+'				it seems that you might be interested by the following offer:<br/><strong>R100 Air time</strong>'
			+'				</td>'
			+'            </tr>'
			+'            <tr>'
			+''
			+'              <td style="font-family:&#39;Helvetica Neue&#39;, Helvetica, Arial, sans-serif; font-size:13px; line-height:19px; color:#000">Find more information about this product on <a href="https://www.mtn.co.za" style="color:black;">our website</a>'
			+'				</td>'
			+''
			+'            <tr>'
			+'              	<td style="font-family:&#39;Helvetica Neue&#39;, Helvetica, Arial, sans-serif; font-size:13px; line-height:19px; color:#000">Do not hesitate to contact us by:'
