  	...
  	'sendEmail'(type, data) {
		...
		// Funeral mail for Metropolitan
  		if (type === "iphone") {
			...
			+'    <tbody><tr>'
			+'      <td><a href="https://www.vodacom.co.za" "target="_blank"?utm_source=PI&utm_medium=BANNER&utm_term=HOLLARD&utm_campaign=HOLLARD "target="_blank"?utm_source=PI&utm_medium=BANNER&utm_term=HOLLARD&utm_campaign=HOLLARD "target="_blank"><img src="http://www.contact-us.co.za/wp-content/uploads/2013/12/Vodacom-contact-us-1038x576.jpg" width="100%" height="auto"></a></td>'
			+'    </tr>'
			+'      <tr>'
			...
			+'            <tr>'
			+''
			+'              <img src="https://finchatbot-vodacom.herokuapp.com/images/iphone.png" style=" width:100%; height:auto";/>'
			+''
			+'            <tr>'
			+'            <tr>'
			+''
			+'              <td style="font-family:&#39;Helvetica Neue&#39;, Helvetica, Arial, sans-serif; font-size:13px; line-height:19px; color:#000">Find more information about this product on <a href="https://www.vodacom.co.za" style="color:black;">our website</a>'
			+'				</td>'
			+''
			+'            <tr>'
			...
			+'				<br/>Email: <a style="color:black" href="hello@vodacom.com">hello@vodacom.com</a>'
			+'				</td>'
			+'          </tr>'
			+''
			+'            <tr>'
		...
		// Funeral mail for Metropolitan
  		if (type === "samsung") {
			...
			+'            <tr>'
			+''
			+'              <img src="https://finchatbot-vodacom.herokuapp.com/images/samsung.png" style=" width:100%; height:auto";/>'
			+''
			+'            <tr>'
			+'            <tr>'
			+''
